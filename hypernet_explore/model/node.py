...
class NODETaskEmbedding(NODE):
    def __init__(self, target_network, te_dim, explicit_time=0, method='dopri5', verbose=False):
        ''' d - ODE dimensionality '''
...
class SINODETaskEmbedding(NODETaskEmbedding):
    def __init__(self, target_network, te_dim, si_c, si_epsilon, explicit_time=0, method='dopri5', verbose=False):
...
class MASNODETaskEmbedding(NODETaskEmbedding):
    def __init__(self, target_network, te_dim, mas_lambda, explicit_time=0, method='dopri5', verbose=False):
        super().__init__(target_network, te_dim, explicit_time, method)
